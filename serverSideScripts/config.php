...
try {
	$con /*just a variable to hold the connection and use in all pages*/ = new PDO('mysql:host=localhost; dbname='/name here/', 'dbusernamehere'/*username*/, 'dbpasswordhere'/*password*/);
