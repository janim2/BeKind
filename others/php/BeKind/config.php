...
try {
	$con /*just a variable to hold the connection and use in all pages*/ = new PDO('mysql:host=localhost; dbname=id2958862_bekind1', 'id2958862_projectbekind'/*username*/, 'b3K!nD2o2o20'/*password*/);
