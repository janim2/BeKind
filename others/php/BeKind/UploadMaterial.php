    ...
    if(isset($_POST["userId"])){
        ...
        if($uploadingIt){
            ...
            if($sentnotifications){
                ...
                $addtodonations = $con->prepare("INSERT INTO Donations(UserId, OrgId, MaterialId, OrgName, OrgImage, Addate, Addtime) 
                VALUES(?,?,?,?,?,curdate(),TIME_FORMAT(CURRENT_TIME(),'%h:%i:%s'))");
                $addtodonations->execute(array($userid,$OrganizationID,$materialID,$getOrgValues["OrgName"],$getOrgValues["orgImage"]));
